...
const s=StyleSheet.create({card:{backgroundColor:colors.white,borderRadius:radius.lg,marginVertical:8,borderWidth:1,borderColor:colors.border,overflow:'hidden',...shadow},compact:{width:248,marginRight:12},pressed:{opacity:.86},art:{height:86,backgroundColor:colors.black,overflow:'hidden',justifyContent:'center',paddingHorizontal:18},artOrb:{position:'absolute',width:150,height:150,borderRadius:75,backgroundColor:colors.purple,right:-38,top:-58,opacity:.82},artLetter:{color:'rgba(255,255,255,.9)',fontSize:46,fontWeight:'950'},artCategory:{position:'absolute',right:15,bottom:10,color:'rgba(255,255,255,.72)',fontSize:10,fontWeight:'900',letterSpacing:1.5},body:{padding:16,gap:7},badges:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:8},badge:{alignSelf:'flex-start',backgroundColor:colors.lilac,borderRadius:99,paddingVertical:5,paddingHorizontal:10},badgeText:{color:colors.purpleDark,fontWeight:'750',fontSize:11},status:{fontSize:10,fontWeight:'800',color:colors.muted,textTransform:'uppercase',letterSpacing:.5},name:{fontSize:20,fontWeight:'900',color:colors.ink},city:{color:colors.muted,fontWeight:'650'},desc:{color:colors.muted,lineHeight:20}});
