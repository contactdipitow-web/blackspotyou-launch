...
const s=StyleSheet.create({page:{flex:1,backgroundColor:colors.canvas},content:{padding:20,paddingTop:58,paddingBottom:118},header:{gap:18},hero:{minHeight:440,borderRadius:radius.xl,overflow:'hidden',justifyContent:'flex-end',...shadow},heroImage:{borderRadius:radius.xl},heroShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(12,8,16,.60)'},heroContent:{padding:22,gap:12},heroCopy:{color:'rgba(255,255,255,.84)',fontSize:15,lineHeight:22,maxWidth:330},heroActions:{marginTop:2},quickRow:{flexDirection:'row',gap:12},quickCard:{flex:1,minHeight:150,borderRadius:radius.lg,backgroundColor:colors.white,borderWidth:1,borderColor:colors.border,padding:16,...shadow},quickIcon:{width:34,height:34,borderRadius:12,backgroundColor:colors.lilac,color:colors.purpleDark,textAlign:'center',textAlignVertical:'center',fontSize:18,fontWeight:'950',lineHeight:34,overflow:'hidden'},quickTitle:{fontSize:17,fontWeight:'900',color:colors.ink,marginTop:12},quickCopy:{fontSize:12.5,lineHeight:18,color:colors.muted,marginTop:4},sectionRow:{marginTop:5,flexDirection:'row',alignItems:'flex-end',justifyContent:'space-between',gap:12},sectionTitle:{fontSize:23,fontWeight:'900',color:colors.ink,marginTop:4},link:{color:colors.purple,fontWeight:'850'},empty:{color:colors.muted,paddingVertical:30,textAlign:'center'},credit:{fontSize:10,color:colors.muted,textAlign:'center',marginTop:16,opacity:.65}});
