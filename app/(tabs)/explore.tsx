...
const s=StyleSheet.create({page:{flex:1,backgroundColor:colors.canvas},list:{padding:20,paddingTop:58,paddingBottom:120},header:{gap:16,marginBottom:8},copy:{color:colors.muted,fontSize:15,lineHeight:22,marginTop:8},searchWrap:{height:56,borderRadius:radius.pill,backgroundColor:colors.white,borderWidth:1,borderColor:colors.border,flexDirection:'row',alignItems:'center',paddingHorizontal:17},searchIcon:{fontSize:24,color:colors.purple,marginRight:8},search:{flex:1,fontSize:16,color:colors.ink},filterHead:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:12},filterTitle:{fontSize:14,fontWeight:'900',color:colors.ink},filterMeta:{fontSize:11,color:colors.muted},chips:{gap:8,paddingRight:10},chip:{minHeight:40,borderRadius:radius.pill,borderWidth:1,borderColor:colors.border,backgroundColor:colors.white,paddingHorizontal:13,flexDirection:'row',alignItems:'center',gap:6},chipOn:{backgroundColor:colors.purple,borderColor:colors.purple},chipText:{fontSize:13,fontWeight:'750',color:colors.ink},chipTextOn:{color:colors.white},check:{color:colors.purple,fontWeight:'950'},checkOn:{color:colors.white},tip:{fontSize:12,color:colors.muted,marginTop:-4}});
